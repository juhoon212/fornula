                    ...
                    <div
                        ...
                        <div class="post-content">
                            ...
                            <form:form method="post" modelAttribute="itemForm"
                                action="<c:url value='/item/add/${expertIdx}'/>">
                                <div class="form-group row" id="expertIdx">
                                    <div class="error-msg"></div>
                                    <div class="col" id="price">
                                        <form:input type="text" class="form-control"
                                            placeholder="가격을 작성해주세요(화폐단위는 생략)"
                                            aria-required="true" required="required" aria-label="Price"
                                            path="price" pattern="\d*" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col" id="itemName">
                                        <form:input type="text" class="form-control"
                                            ...
                                            required="required" aria-label="Subject" path="itemName"
                                            required />
                                    </div>
                                </div>
                                <div class="form-group row" id="itemContent">
                                    <div class="col">
                                        <form:textarea class="form-control" rows="20"
                                            placeholder="상품설명" aria-required="true" required="required"
                                            aria-label="Message" path="itemContent" required></form:textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="info" id="info__category">
                                            <div id="category-flex">
                                                <form:select class="box" id="category-big1"
                                                    onchange="categorySelect1(this)" path="categoryIdx">
                                                    <form:option value="" label="대 카테고리" />
                                                    <form:option value="a" label="디자인" />
                                                    <form:option value="b" label="번역" />
                                                    <form:option value="c" label="사진 편집" />
                                                    <form:option value="d" label="세무" />
                                                    <form:option value="e" label="마케팅" />
                                                </form:select>
