...
<head>
    <meta charset="utf-8">
    <title>Lana Pet - Footer (Grid - 3 Columns)</title>
...
<body class="page page-template page-template-template-full-width">
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="additional-dropdown">
                        ...
                        <li>
                            <a class="dropdown-item active" href="footer-grid-3-columns.html">
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-6 text-center">
                <h1 class="mb-4 font-weight-bold">Footer</h1>
                <p>There are 3 columns in this footer layout.</p>
                <div class="lana-hr lana-hr-4 border-primary mt-4 mb-5"></div>

                <i class="fas fa-arrow-down fa-3x d-block"></i>
            </div>
        </div>
    </div>
</main>

<div class="pre-footer footer-grid-3 bg-dark text-white">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="widget">
                    <img class="footer-logo img-fluid mb-4" src="../pictures/placeholder/190x50.svg"
                         alt="Footer Logo">
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam non odio nec metus tristique
                        vestibulum. Maecenas mattis vestibulum neque.
                    </p>
            ...
            <div class="col-md-4">
                <div class="widget">
                    ...
                    <ul>
                        <li><a href="front-page.html">Front Page</a></li>
                        <li><a href="page.html">Page (Default Template)</a></li>
                        <li><a href="template-contact.html">Contact (Template)</a></li>
                        <li><a href="template-our-services.html">Our Services (Template)</a></li>
                        <li><a href="template-our-partners.html">Our Partners (Template)</a></li>
                        <li><a href="template-our-team.html">Our Team (Template)</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
                <div class="widget">
                    <h3 class="widget-title">Post Types</h3>
                    <ul>
                        <li><a href="archive.html">Posts (Archive)</a></li>
                        <li><a href="single.html">Post (Single)</a></li>
                        <li><a href="archive-lana_pet.html">Pets (Archive)</a></li>
                        <li><a href="single-lana_pet.html">Pet (Single)</a></li>
                    </ul>
                </div>
            </div>
        </div>
