										...
										<div class="card-body">
											<div class="blog-posts">
												<div id="post-2" class="post type-post post-2 card post-card">
													<a href="<c:url value="/item/update/${boardList.itemIdx}"/>" class="more-link card-link d-flex align-items-center">상품수정</a>
													<p class="post-text card-text">
													<h4 class="post-title card-title">
														<a href="<c:url value="/item/${boardList.itemIdx}/1"/>">상품 제목 : ${boardList.itemName}</a>
													</h4>

													<div class="row">
														<div class="col-md-4">
															<img class="card-img img-fluid" src="<c:url value='/images/upload/${boardList.itemfileName}'/>" alt="Post">
														</div>
														<div class="col-md-8">
						...
						<nav style="padding: 5px;" class="navigation pagination justify-content-between text-uppercase" role="navigation">
							...
							<div class="nav-links">
								<ul class="page-numbers">
									...
									<li><a class="page-numbers" href="<c:url value="#"/>">3</a></li>
									<li><a class="page-numbers" href="<c:url value="#"/>">4</a></li>
									<li><a class="page-numbers" href="<c:url value="#"/>">5</a></li>
								</ul>
							</div>
