...
<div class="row">
	<div class="col-12 col-lg-8">
		<div class="widget"> 
			<div class="box" style="height:800px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
...
본 사이트는 전자상거래법에 의거하여 소비자 보호 및 판매자 공정 거래 원칙을 따르고 있음을 명시한다
		    ...
		    <div style="text-align: center; margin-top: auto;">
		        <a href="https://www.ftc.go.kr/www/FtcRelLawUList.do?key=290&law_div_cd=07" target="_blank" style="margin-bottom: 10px;">전자상거래법 보기</a>
