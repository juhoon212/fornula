            ...
            <div class="row justify-content-start post-row no-gutters">
                <div class="col-12 px-0 px-sm-3 col-md-10 offset-md-1 px-md-0 col-xl-9">
                    <div class="post-content">
                        <h4 class="font-weight-bold">상품사진 수정</h4>
                        <p>규정을 준수하여 상품을 등록해주세요</p>
                    <form action="<c:url value="/photo/update/${itemIdx}"/>" method="POST" enctype="multipart/form-data">
                        <section id="upload">
								<h3>사진 등록</h3>
						...
						<button id="submit" type="submit" class="btn btn-primary" style="font-size:20px;">상품 사진 수정</button>
					</form>
					</div>
				</div>
			</div>
