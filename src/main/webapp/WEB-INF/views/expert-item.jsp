...
본 사이트는 전자상거래법에 의거하여 소비자 보호 및 판매자 공정 거래 원칙을 따르고 있음을 명시한다
               ...
               <a id="goPage" href="https://www.ftc.go.kr/www/FtcRelLawUList.do?key=290&law_div_cd=07" target="_blank" style="margin-bottom: 10px; color: #A55858;">전자상거래법 보기 -></a>
               <br>
               <input type="checkbox" name="agree" onclick="toggleSubmitButton(this)">&nbsp;동의 시 상품등록이 가능합니다
            </div>
          <div style="text-align: center; margin-top: auto;">
              <button id="checkSubmit" type="submit" onclick="location.href='<c:url value="/item/add/${expertIdx}"/>'" style="text-align:center;" name="checkBtn" onclick="location.href='<c:url value="/item/add/${expertIdx}"/>'" disabled>상품등록</button>
          </div>
         </div>
      </div>
   </div>
