							...
							<li class="nav-item dropdown"><a
								...
								<ul class="dropdown-menu" aria-labelledby="page-dropdown">
									...
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=1"/>">그래픽
											디자인</a></li>
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=2"/>">제품
											디자인</a></li>
									<li>
										<h6 class="dropdown-header font-weight-medium text-primary">번역</h6>
									</li>
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=3"/>">영어
											번역</a></li>
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=4"/>">중국어
											번역</a></li>
									<li>
										<h6 class="dropdown-header font-weight-medium text-primary">사진·편집</h6>
									</li>
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=5"/>">헤어
											메이크업</a></li>
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=6"/>">제품·홍보
											사진</a></li>
									<li>
										<h6 class="dropdown-header font-weight-medium text-primary">세무</h6>
									</li>
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=7"/>">사업자
											세무</a></li>
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=8"/>">개인
											세무</a></li>
									<li>
										<h6 class="dropdown-header font-weight-medium text-primary">마케팅</h6>
									</li>
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=9"/>">SNS
											홍보</a></li>
									<li><a class="dropdown-item"
										href="<c:url value="/item/boardList?categoryIdx=10"/>">해외
											마케팅</a></li>
								</ul>
							<li><a class="nav-link"
