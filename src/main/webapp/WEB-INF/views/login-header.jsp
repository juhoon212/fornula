		...
		<div class="header-navbar border-bottom border-white">
			<nav
				...
				<a class="navbar-brand" href="<c:url value="/index.html"/>">
					<img class="navbar-logo" src="<c:url value="/pictures/placeholder/logo_label.png"/>"
					alt="Navbar Logo">
				</a>
						...
						<div class="dropdown">
							<div class="profile">
								<a class="dropdown-toggle" href="my-page" role="button"
									...
									src="<c:url value="/pictures/placeholder/65x65.svg"/>" class="rounded-circle"
									alt="profilephoto" width="60" height="60">
								</a>
