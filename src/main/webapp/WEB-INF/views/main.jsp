	...
	<main class="main">
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-12 col-md-10 col-lg-6 text-center">
						<h1 class="mb-4 font-weight-bold" data-scroll-animate="fadeInDown">Our
							Services</h1>
						<p data-scroll-animate="fadeInUp">We have following services
							for help animals.</p>
				...
				<div class="row mt-4">
					<div class="col-12 col-sm-6 col-lg-3 py-4 py-lg-0">
						<div
							...
							<div class="card-body" data-scroll-animate="fadeIn">
								<h5 class="post-title card-title">Adoption</h5>
								<p class="post-text card-text">Lorem ipsum dolor sit amet,
									consectetur adipiscing elit. Donec sit amet ultricies dui, et
									posuere lacus. Vestibulum accumsan justo eget justo rhoncus
									convallis.</p>
							</div>
						</div>
					</div>
					<div class="col-12 col-sm-6 col-lg-3 py-4 py-lg-0">
						<div
							...
							<div class="card-body" data-scroll-animate="fadeIn">
								<h5 class="post-title card-title">Dog walking</h5>
								<p class="post-text card-text">Nullam in malesuada turpis.
									Phasellus eget consectetur odio. Donec aliquam ac felis vel
					...
					<div class="col-12 col-sm-6 col-lg-3 py-4 py-lg-0">
						<div
							...
							<div class="card-body" data-scroll-animate="fadeIn">
								<h5 class="post-title card-title">Dog training</h5>
								<p class="post-text card-text">Suspendisse porta eget odio
									eu faucibus. Vestibulum ullamcorper nulla sapien, ac pulvinar
									elit ultrices quis. Sed at ante eget nisi congue tristique.</p>
							</div>
						</div>
					</div>
					<div class="col-12 col-sm-6 col-lg-3 py-4 py-lg-0">
						<div
							...
							<div class="card-body" data-scroll-animate="fadeIn">
								<h5 class="post-title card-title">Volunteer</h5>
								<p class="post-text card-text">Aenean sapien lectus, viverra
									ut auctor quis, tempus eget erat. Sed ut bibendum diam, ac
									fringilla turpis. Aenean finibus feugiat elit at accumsan.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row mt-5">
					<div class="col-12 px-0">
						<div
							class="pets-carousel swiper-container swiper-container-items h-100">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div
										class="lana_pet type-lana_pet card pet-grid-card mx-0 mx-md-3 h-100"
										data-scroll-animate="fadeIn">
										<div class="lana-img-zoom">
											<img src="../pictures/placeholder/530x400.svg"
												class="card-img-top img-fluid" alt="Pet">
										</div>
										<div class="card-body">
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Ut eu tempor lectus. Nulla
												odio nisl, dictum id facilisis et, luctus varius nisi.
												Aliquam eu nisl sit amet diam convallis commodo.</p>
										</div>
										<div class="card-footer">
											<p class="card-text">
												<a href="#" class="more-link card-link"> Learn More <i
								...
								<div class="swiper-slide">
									<div
										...
										<div class="card-body">
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Lorem ipsum dolor sit
								...
								<div class="swiper-slide">
									<div
										...
										<div class="card-body">
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Suspendisse vel ornare
												velit. Donec enim erat, maximus non lobortis sit amet,
												ornare ac nibh.</p>
										</div>
										<div class="card-footer">
											<p class="card-text">
								...
								<div class="swiper-slide">
									<div
										...
										<div class="card-body">
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Nulla facilisi. Sed
												molestie facilisis posuere.</p>
										</div>
										<div class="card-footer">
											<p class="card-text">
												<a href="#" class="more-link card-link"> Learn More <i
								...
								<div class="swiper-slide">
									<div
										...
										<div class="card-body">
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Duis vehicula mauris
												ipsum, at semper ex tincidunt vitae. Curabitur gravida
												sapien id imperdiet fringilla.</p>
										</div>
										<div class="card-footer">
											<p class="card-text">
												<a href="#" class="more-link card-link"> Learn More <i
								...
								<div class="swiper-slide">
									<div
										...
										<div class="card-body">
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Etiam quis urna faucibus,
												vestibulum elit in, sagittis augue. Vivamus ut augue odio.</p>
										</div>
										<div class="card-footer">
											<p class="card-text">
												<a href="#" class="more-link card-link"> Learn More <i
		...
		<div id="latest-posts-container"
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-12 col-md-10 col-lg-6 text-center">
						<h1 class="mb-4 font-weight-bold" data-scroll-animate="fadeInDown">Latest
							Posts</h1>
						<p data-scroll-animate="fadeInUp">We regularly write articles
							in our blog in order to share with you all the information we
							know about animals and their care.</p>
						<div class="lana-hr lana-hr-4 border-primary mt-4"
							data-scroll-animate="zoomIn"></div>
					</div>
				</div>
				<div class="row mt-4 mb-5">
					<div class="col-12 px-0">
						<div
							class="latest-posts-carousel swiper-container swiper-container-items swiper-visible-items h-100">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<a
										class="post type-post card post-slide-card px-0 px-sm-3 h-100"
										href="single.html" data-scroll-animate="fadeIn">
										<div class="card-body">
											<h6 class="card-subtitle">Oct 17, 2018 / Cats, Dogs</h6>
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Donec vitae iaculis ipsum,
												quis feugiat erat. Phasellus felis nisl, ornare quis leo id,
												tincidunt aliquet odio.</p>
										</div>
										<div class="card-footer">
											<div class="media">
								...
								<div class="swiper-slide">
									<a
										...
										href="single.html" data-scroll-animate="fadeIn">
										<div class="card-body">
											<h6 class="card-subtitle">Oct 10, 2018 / Cats, Dogs</h6>
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Suspendisse potenti. Morbi
												ultricies neque eget nisi posuere suscipit.</p>
										</div>
										<div class="card-footer">
											<div class="media">
												<img src="../pictures/placeholder/32x32.svg"
								...
								<div class="swiper-slide">
									<a
										...
										href="single.html" data-scroll-animate="fadeIn">
										<div class="card-body">
											<h6 class="card-subtitle">Sept 20, 2018 / Cats, Dogs</h6>
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Orci varius natoque
								...
								<div class="swiper-slide">
									<a
										...
										href="single.html" data-scroll-animate="fadeIn">
										<div class="card-body">
											<h6 class="card-subtitle">Sept 15, 2018 / Cats, Dogs</h6>
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Fusce leo nunc, gravida et
												maximus non, semper eu enim.</p>
										</div>
										<div class="card-footer">
											<div class="media">
												<img src="../pictures/placeholder/32x32.svg"
								...
								<div class="swiper-slide">
									<a
										...
										href="single.html" data-scroll-animate="fadeIn">
										<div class="card-body">
											<h6 class="card-subtitle">Aug 21, 2018 / Cats, Dogs</h6>
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Suspendisse iaculis enim
												at est porttitor, elementum pharetra sem varius.</p>
										</div>
										<div class="card-footer">
											<div class="media">
												<img src="../pictures/placeholder/32x32.svg"
								...
								<div class="swiper-slide">
									<a
										...
										<div class="card-body">
											...
											<h5 class="post-title card-title">Know your pet adoption
												options</h5>
											<p class="post-text card-text">Aenean eget sapien nunc.
												In pharetra, sapien eget volutpat suscipit, dui ex rutrum
												risus, ac commodo magna purus in massa.</p>
										</div>
										<div class="card-footer">
											<div class="media">
												<img src="../pictures/placeholder/32x32.svg"
				...
				<div class="row">
					<div class="col-12 text-center">
						<a href="#"
							class="btn btn-primary btn-lg text-uppercase font-weight-bold w-15x">Read
							More</a>
					</div>
				</div>
			</div>
