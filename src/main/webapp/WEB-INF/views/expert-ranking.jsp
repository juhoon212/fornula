			...
			<div id="managers-container" class="container my-5">
				<div class="row justify-content-center">
					<div class="col-12 col-md-10 col-lg-6 text-center">
						<h1 class="mb-4 font-weight-bold" data-scroll-animate="fadeInDown">판매
							금액 랭킹</h1>
						...
						<div
							...
							<div class="card-body">
								...
								<h5 class="post-title card-title"
									...
									<a
										href="<c:url value='/expert/output/${expertList.expertIdx}'/>">전문가 번호:13</a>
								</h5>
						...
						<c:forEach var="i" begin="${pager.startPage }"
							...
							<c:choose>
								<c:when test="${pager.pageNum != i}">
									<li><a
										href="<c:url value="/expert/ranking"/>?pageNum=${i}">${i}</a>
									<li>
								</c:when>
								<c:otherwise>
									${i}
