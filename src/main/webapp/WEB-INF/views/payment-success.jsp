...
<header class="header lana-full-bg-image-black-and-white-medium-staring-dog-face-within-fence text-white d-flex flex-column">
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="page-dropdown">
                        ...
                        <li><a class="dropdown-item active" href="404.html">404 (Error Page)</a></li>
                    </ul>
                </li>
    ...
    <main class="main container-fluid">
        <div class="row">
            <div class="col-12 col-md-9 col-lg-8 col-xl-7">
                ...
                <a href="#"
                   class="btn btn-outline-primary btn-lg text-white text-uppercase font-weight-bold mr-3 mt-3 w-10x">
                    <i class="lana-icon-arrow-left text-white mr-2"></i> Back
                </a>
                <a href="#" class="btn btn-primary btn-lg text-uppercase font-weight-bold mt-3 w-15x">
                    Adopt a Pet
                </a>
            </div>
        </div>
